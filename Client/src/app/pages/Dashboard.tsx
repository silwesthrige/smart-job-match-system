...
export function Dashboard() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        // Fetch matches (returns general jobs if no CV)
        ...
        // Try to fetch skill gap (fails with 404 if no CV)
        try {
          ...
          <div className="max-w-7xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-gray-600">
                {hasCv ? "Welcome back! Here's your job search overview." : "Upload your resume to get personalized matches and skill analysis."}
              </p>
            </div>
              ...
              <div className="lg:col-span-2">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold text-gray-900">
                    {hasCv ? "Top Job Matches" : "Recent Global Jobs"}
                  </h2>
                  <Link to="/jobs">
                ...
                <div className="space-y-4">
                  {topMatches.length > 0 ? (
                    ...
                    <p className="text-gray-500">No jobs found. Try clicking 'Browse Jobs' to refresh.</p>
                  )}
                </div>
              </div>
                  ...
                  <div className="space-y-3">
                    {skillGap.length > 0 ? (
                      ...
                      <div className="text-center py-4">
                        <p className="text-sm text-gray-500 mb-4">Upload your resume to see skill gaps.</p>
                        <Link to="/resume">
                          <Button size="sm" variant="outline">Upload Now</Button>
                        </Link>
                      </div>
                    )}
                  </div>
